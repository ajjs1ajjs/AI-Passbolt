...
> **Примітка:** Скріншоти будуть додані найближчим часом. Зараз ви можете запустити програму щоб побачити інтерфейс:
> ```bash
> python ai.py
> ```

<!-- Скріншоти будуть оновлені:
### Головне вікно
...
- **14** тестових випадків
- **4** формати Excel підтримуються
- **100%** сумісність з Passbolt
- **5** мов програмування в тестах (Python)
